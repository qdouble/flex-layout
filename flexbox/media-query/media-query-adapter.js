...
export var MediaQueryAdapter = (function () {
    ...
    MediaQueryAdapter.prototype._buildRegistryMap = function (directive, key) {
        return this._breakpoints.registry
            ...
            .filter(function (it) { return directive[it.key] != null; });
    };
    /**
     ...
     * notification
     */
    MediaQueryAdapter.prototype._configureChangeObservers = function (directive, property, keys, callback) {
        var _this = this;
        var subscriptions = [];
        keys.forEach(function (it) {
            ...
            if (directive[it.key] != null) {
                ...
                subscription = _this._mq.observe(it.alias)
    ...
    MediaQueryAdapter.prototype._isDifferentChange = function (previous, current) {
        ...
        var sameProperty = current.property === (previous ? previous.property : undefined);
