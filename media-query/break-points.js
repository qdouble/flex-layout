...
export var BreakPoints = (function () {
     ...
     */
    BreakPoints.prototype.findByAlias = function (alias) {
        return this.registry.find(function (bp) { return bp.alias == alias; });
    };
    BreakPoints.prototype.findByQuery = function (query) {
        return this.registry.find(function (bp) { return bp.mediaQuery == query; });
    };
