...
export var MediaQueryChange = (function () {
    function MediaQueryChange(matches, // Is the mq currently activated
        ...
        property // base property associated with the change
        ) {
...
export var MediaQueries = (function () {
     ...
     */
    MediaQueries.prototype._prepareWatchers = function (ranges) {
        var _this = this;
        ranges.registry.forEach(function (it) {
     ...
     */
    MediaQueries.prototype._onMQLEvent = function (breakpoint, mql) {
        var _this = this;
        this._zone.run(function () {
            // console.log(`mq[ ${breakpoint.alias} ]: active = ${mql.matches}, mediaQuery = ${breakpoint.mediaQuery} `);
            var change = new MediaQueryChange(mql.matches, breakpoint.alias, breakpoint.suffix, breakpoint.mediaQuery);
